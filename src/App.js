      ...
      <div className="App">
        ...
        <div class="page-wrapper" id="home-page-wrapper">
          ...
          <Grid container spacing={40} style={styles.Grid}>
            ...
            <Grid item xs>
              <FeatureCard title="Birthday Cupcakes" image={Mission} content="We've given over 740 cupcakes to needy children in the Kansas City community"/>
            </Grid>
            <Grid item xs>
              <FeatureCard title="Comfort &amp; Joy Packs" image={Values} content="Last Christmas, we create Comfort &amp; Joy packs with 31 children at Joyce Williams Domestic Violence Shelter."/>
            </Grid>
          </Grid>
          <Paper style={styles.Paper}>
            <Grid container>
              ...
              <Grid item xs>
                <Typography component="h2" variant="display1" gutterBottom>Recognition and Acknowledgement for Compassionate Partners KC's Community Services</Typography>
