  ...
  <div className="who-page-container">
    ...
    <div className="page-wrapper" id="home-page-wrapper">
      ...
      <Grid container spacing={24}>
        ...
        <Grid item xs>
          <FeatureCard
            title="Comfort &amp; Joy Care Packages"
            image={ComfortAndJoy}
      ...
      <Grid container spacing={24}>
        <Grid item xs>
          <FeatureCard
            ...
            image={SummerReading}
            content="Summers are difficult for children in domestic violence shelters.  CPKC sponsors an eight-week summer reading program exclusively for children in domestic violence shelters.  Our goals are to prevent summer learning loss, improve reading proficiency and provide entertainment through the magic that only reading provides."
          />
        </Grid>
        <Grid item xs>
          <FeatureCard
            ...
            image={MothersDay}
            content="As we honor our mothers each year on Mother’s Day, CPKC does not forget the hundreds of mothers and children seeking safe shelter in domestic violence shelters in Kansas (link) and Missouri (link). CPKC shows our support to Mothers in domestic violence shelters by giving every mother a vintage teacup floral arrangement. We want them to know there are people in our community praying they find strength and courage to provide the best they can for themselves and their children."
          />
        </Grid>
      </Grid>
      <Grid container spacing={24}>
