          ...
          <Paper style={styles.Paper}>
            <Grid container>
              ...
              <Grid item md xs={12}>
                ...
                <p>
                  Creating partnerships with organizations to help build resilience in children and
                  youth experiencing adversity and trauma.
                </p>
                <Typography component="h2" variant="display1" gutterBottom>
                  Our Vision
                </Typography>
                <p>
                  We envision communities where there is an abundance of sustainable organizations
                  available to provide social and mental health services to children and youth
                  affected by family trauma and personal crises.{' '}
                </p>
                <Typography component="h2" variant="display1" gutterBottom>
                  Our Values
                </Typography>
