          ...
          <Paper style={styles.Paper}>
            <Grid container>
                <Grid item xs>
                    ...
                    <br/>
                    <br/>
                    <p>The focus of CPKC’s attention is directed towards the silent victims of domestic violence and homelessness, the children.</p>
                    <p>Children experiencing childhood trauma(the words childhood trauma) need to provide a link to link below) is high in Wyandotte County. According to the 2016 Community Health Needs Assessment conducted by Children’s Mercy Hospital, when compared to Clay County, Jackson County and Johnson County, Wyandotte County had the highest number of children who experienced at least one Adverse Childhood Experience. 48.5% of children surveyed.</p>
                </Grid>
            </Grid>
          </Paper>
